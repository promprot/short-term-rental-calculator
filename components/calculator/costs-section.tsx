      ...
      {isOpen && (
        <CardContent className="space-y-6">
          ...
          <SliderField
            ...
            step={0.25}
            suffix="%"
            description="Percentage of gross revenue paid to property management companies. Most owners self-manage (0%) to maximize profits. Professional management typically charges 15-30% for full-service including guest communication, cleaning coordination, maintenance, and marketing."
          />
          ...
          <InputField
            ...
            prefix="$"
            description="Annual homeowner association fees for condos, townhomes, or communities with shared amenities. Sometimes includes maintenance of common areas, amenities, and sometimes utilities like water/trash."
            placeholder="0"
          />
